...
export default function ProfileScreen() {
  ...
  if (!isLoaded || !user) {
    return (
      <SafeAreaView className="flex-1 bg-white mb-10 items-center justify-center">
  ...
  return (
    ...
    >
      <View className="flex-1 grid grid-rows-[auto,1fr,auto]">
        {/* Avatar + Name */}
        ...
        <View className="px-6 gap-2">
          ...
          <MenuItem
            ...
            onPress={() =>
              Linking.openURL(
                "mailto:mfaibrahem@gmail.com?subject=Help%20%26%20Support%20-%Rent%20App",
              )
            }
          />
        </View>
